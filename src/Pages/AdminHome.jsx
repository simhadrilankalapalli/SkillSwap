...
export default function AdminHome() {
  return (
    <div>
      {/* Hero Section */}
      <div className="relative w-auto h-screen overflow-hidden left-0 right-0 bg-blue-300 top-0">
        {/* Background Image */}
        <img
          src={skillImage}
        ...
        <div className="absolute inset-0 flex items-center justify-center px-6 bg-black bg-opacity-40 overflow-hidden">
