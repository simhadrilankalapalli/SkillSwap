...
function SkillCard({ skill, isBookmarked, handleBookmarkClick }) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition flex flex-col p-0.5 mx-2">
      <a
        href={skill.link}
        target="_blank"
      ...
      <div className="text-sm text-gray-700 px-2 mt-2 space-y-1">
        <p>
          <strong>Email:</strong> {skill.emailid || "Not provided"}
        </p>
        <p>
          <strong>Contact:</strong> {skill.phnumber || "Not provided"}
        </p>
      </div>
...
export default function ExpertInsights() {
  ...
  return (
    <section className="px-6 md:px-16 py-16 bg-blue-50 min-h-screen">
      <h1 className="text-4xl font-bold text-[#0C4484] mb-10 text-center pt-[50px]">
        Expert Insights
      </h1>
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-center gap-4 mt-12">
            <button
              ...
              className="px-4 py-2 text-sm rounded border bg-white hover:bg-blue-50 disabled:opacity-40"
            >
              Previous
            </button>
